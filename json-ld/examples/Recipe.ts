...
// A recipe.
// For dietary restrictions covered by the recipe, a few common restrictions are enumerated via suitableForDiet.
// The keywords property can also be used to add more detail.
export const createJsonLd = (data: any): WithContext<Recipe> => {
  return {
