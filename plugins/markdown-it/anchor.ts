...
export const slugify = (s: any) => {
  ...
  const withoutRepeatingDashes = withoutLeadingTrailingDashes.replace(
    /-+/g,
    "-"
  );
...
const isLevelSelectedNumber = (selection: any) => (level: any) =>
  level >= selection;
const isLevelSelectedArray = (selection: any) => (level: any) =>
  ...
  md.core.ruler.push("anchor", (state: any) => {
    ...
    for (let idx = 0; idx < tokens.length; idx++) {
      ...
      if (typeof opts.permalink === "function") {
        ...
        opts.renderPermalink !== permalink.legacy
      ) {
        opts.renderPermalink(slug, opts, state, idx);
      }
...
anchor.defaults = {
  ...
  permalinkSymbol: "¶",
  permalinkBefore:
    (permalink.ariaHidden.defaults as any).placement === "before",
